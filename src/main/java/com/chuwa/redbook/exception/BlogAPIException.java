...
public class BlogAPIException extends RuntimeException {
    ...
    /**
     * Constructs a new run-time exception with the specified detail message.
     * The cause is not initialized and may subsequently be initialized by a call to {@link  #initCause}.
     *
     * @param message the detail message. It is saved for later retrieval by the {@link #getMessage()}.
     * @param httpStatus
     * @param message1
     */
