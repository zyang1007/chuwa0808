...
public class CommentServiceImpl implements CommentService {
    ...
    @Autowired
    private ModelMapper modelMapper; // replace mapToDto & mapToEntity with modelMapper

    @Override
    public CommentDto createComment(long postId, CommentDto commentDto) {
        Comment comment = modelMapper.map(commentDto, Comment.class);  // convert the commentDto to comment entity
    ...
    public List<CommentDto> getCommentsByPostId(long postId) {
        ...
        return comments.stream().map(e -> modelMapper.map(e, CommentDto.class)).collect(Collectors.toList());
    }
